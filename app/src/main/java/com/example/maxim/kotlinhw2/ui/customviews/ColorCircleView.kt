...
class ColorCircleView @JvmOverloads constructor(context: Context,
    ...
    @Dimension(unit = DP) private val defRadiusDp = 16
    @Dimension(unit = DP) private val defStrokeWidthDp = 1
    ...
    init {
        ...
        strokeColorRes = a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.color_text_secondary)
        a.recycle()
    }
